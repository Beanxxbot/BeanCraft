...
public class ItemRendererBioInfuser implements IItemRenderer
{

    //private ModelBioGen model;
    private TileEntitySpecialRenderer render1;
    private TileEntity dummytile;

    public ItemRendererBioInfuser(TileEntitySpecialRenderer render, TileEntity dummy)
    {
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        this.render1.renderTileEntityAt(this.dummytile, 0.0D, 0.0D, 0.0D, 0.0F);
    }
}

...
public class WorldGenGenericTree extends WorldGenAbstractTree
{
    ...
    public WorldGenGenericTree(boolean p_i45461_1_)
    {
        super(p_i45461_1_);
    }
    ...
    public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
    {
        ...
        if (p_76484_4_ >= 1 && p_76484_4_ + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = block2.canSustainPlant(p_76484_1_, p_76484_3_, p_76484_4_ - 1, p_76484_5_, ForgeDirection.UP, ModBlocks.beanSapling);
                if (isSoil && p_76484_4_ < 256 - l - 1)
                {
                    ...
                    for (j2 = 0; j2 < l; ++j2)
                    {
                        ...
                        {
                            this.setBlockAndNotifyAdequately(p_76484_1_, k3, k2, l1, Blocks.log, 0);
                            this.setBlockAndNotifyAdequately(p_76484_1_, k3 + 1, k2, l1, Blocks.log, 0);
                            this.setBlockAndNotifyAdequately(p_76484_1_, k3, k2, l1 + 1, Blocks.log, 0);
                            this.setBlockAndNotifyAdequately(p_76484_1_, k3 + 1, k2, l1 + 1, Blocks.log, 0);
                            i2 = k2;
                        }
                    }
                    ...
                    for (j2 = -1; j2 <= 2; ++j2)
                    {
                        for (k2 = -1; k2 <= 2; ++k2)
                        {
                            if ((j2 < 0 || j2 > 1 || k2 < 0 || k2 > 1) && p_76484_2_.nextInt(3) <= 0)
                            {
                                ...
                                for (l2 = 0; l2 < l3; ++l2)
                                {
                                    this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_ + j2, i2 - l2 - 1, p_76484_5_ + k2, Blocks.log, 0);
                                }
    ...
    private void func_150526_a(World p_150526_1_, int p_150526_2_, int p_150526_3_, int p_150526_4_)
    {
        ...
        {
            this.setBlockAndNotifyAdequately(p_150526_1_, p_150526_2_, p_150526_3_, p_150526_4_, ModBlocks.bcLeaves, 1);
        }
    }
